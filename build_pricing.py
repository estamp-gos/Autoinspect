...
index_path = r'c:\Users\S.K Tech\OneDrive\Desktop\web-terms\wheelstory\index.html'
output_path = r'c:\Users\S.K Tech\OneDrive\Desktop\web-terms\wheelstory\pricing.html'

with open(index_path, 'r', encoding='utf-8') as f:
    lines = f.readlines()

head = "".join(lines[0:10343])
footer = "".join(lines[11825:])
...
<section class="pricing-section" style="padding: 100px 0; background: var(--basic-white);">
    <div class="container holder">
        ...
        <div class="pricing-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
            ...
            <!-- Standard Plan -->
            <div class="pricing-card" style="background: var(--basic-white); border: 2px solid var(--main-blue); border-radius: 20px; padding: 40px; text-align: center; position: relative; transform: scale(1.05); box-shadow: 0 10px 30px rgba(4, 147, 211, 0.15);">
