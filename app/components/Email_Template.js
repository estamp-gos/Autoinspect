...
export default function Email_Template({vin , email, carModel, tierName, tierPrice}) {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', padding: '20px', color: '#333' }}>
      ...
      <p>
        We have received your order for the <strong>Autoinspect {tierName} Report</strong>, but we have not yet received your payment.
      ...
      <div style={{ 
        ...
        <p><strong>Price:</strong> £{tierPrice || 54.99}</p>
      ...
      <p>
        ...
        >
          🔗 Complete Payment - £{tierPrice || 54.99}
        </a>
      </p>
