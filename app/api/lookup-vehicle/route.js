...
/** @typedef {{ make: string; model: string; bodyStyle: string; engine: string; transmission: string; fuelType: string; color: string; doors: string; driveTrain: string }} VehicleDetails */
...
For a ${year} ${vehicleModel}, provide typical specifications. Return ONLY a valid JSON object (no explanation, no markdown):
{
  ...
  "model": "the exact model name without year",
  ...
  "doors": "number of doors as a digit, e.g. 4",
