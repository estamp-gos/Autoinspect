...
/** Admin inbox for new report requests and form submissions */
export const ADMIN_NOTIFICATION_EMAIL = PROOF_EMAIL_TO;
/** Do not send customer payment reminders to these addresses */
export const REMINDER_EXCLUDED_EMAILS = [ADMIN_NOTIFICATION_EMAIL];
