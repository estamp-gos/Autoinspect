/** DocuKit × Autoinspect payment integration (Paddle via payments.docukit.site) */

export const DOCUKIT_PAYMENT_URL = 'https://payments.docukit.site/autoinspect.php';
...
export const DOCUKIT_SUCCESS_URL = 'https://www.autoinspect.site/thankyou';
...
export function getDefaultSuccessUrl() {
  if (typeof window !== 'undefined' && !window.location.hostname.includes('autoinspect.site')) {
